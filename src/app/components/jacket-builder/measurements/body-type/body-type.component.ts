...
export class BodyTypeComponent implements OnInit, AfterViewInit {
  ...
  private bodyTypesMock: any[] = [
    {"name": "1", "desc": "Collar Description", "price": "200", "url": "assets/jacket-builder/pants/pants-v1.png"},
    {"name": "2", "desc": "Collar Description", "price": "200", "url": "assets/jacket-builder/pants/pants-v2.png"},
    {"name": "3", "desc": "Collar Description", "price": "200", "url": "assets/jacket-builder/pants/pants-v3.png"},
  ];
